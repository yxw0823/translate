...
{
  public static Writer NULL_WRITER = new NullWriter(null);
  ...
  public static void saveFile(File file, String content, String encoding, boolean append) {
    try {
      ...
      Writer writer = (StringUtils.isEmpty(encoding)) ? new OutputStreamWriter(output) : new OutputStreamWriter(output, encoding);
  ...
  public static void close(InputStream in, OutputStream out) {
    try {
      if (in != null) in.close();  } catch (Exception e) {
    }try {
  ...
  {
    public NullWriter(Object object) {

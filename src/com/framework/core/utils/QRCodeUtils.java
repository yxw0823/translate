...
import com.framework.core.domain.QRCodeVO;
...
public class QRCodeUtils {
     ...
     * @return 
     */  
    private  synchronized static  BufferedImage qRCodeCommon(String content, String imgType, int size) {  
     ...
     * @return 
     */  
    public synchronized static String decoderQRCode(String imgPath) {  
        // QRCode 二维码图片的文件  
        ...
        try {  
            ...
            content = new String(decoder.decode(new QRCodeVO(bufImg)), "utf-8");   
        } catch (IOException e) {  
    ...
    public static void main(String[] args) {  
        ...
        String encoderContent = " welcome to 易象软件!" + "\n [ http://www.baidu.com ]" + "\n [ gonggongjian@gmail.com ]";

package com.apps.userinfo.moblie;
...
*/
@Controller
@RequestMapping("/apps/app/userinfo/VoMobileUserinforAction.do")
public class VoMobileUserinforAction extends BaseToolAction {
	@Autowired
